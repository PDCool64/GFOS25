...
@NamedQueries({@NamedQuery(name = "Account.findAll", query = "SELECT a FROM Account a"),
    ...
    @NamedQuery(name = "Account.findByVorname",
        query = "SELECT a FROM Account a WHERE a.vorname = :vorname"),
    @NamedQuery(name = "Account.findByNachname",
        query = "SELECT a FROM Account a WHERE a.nachname = :nachname"),
    @NamedQuery(name = "Account.findByEmail",
        query = "SELECT a FROM Account a WHERE a.email = :email"),
    @NamedQuery(name = "Account.findByTelefonnummer",
        query = "SELECT a FROM Account a WHERE a.telefonnummer = :telefonnummer"),
    @NamedQuery(name = "Account.findByRang",
        query = "SELECT a FROM Account a WHERE a.rang = :rang"),
    @NamedQuery(name = "Account.findByUtcOffset",
        query = "SELECT a FROM Account a WHERE a.utcOffset = :utcOffset"),
    @NamedQuery(name = "Account.findByRegion",
        query = "SELECT a FROM Account a WHERE a.region = :region"),
    @NamedQuery(name = "Account.findByRefreshToken",
        query = "SELECT a FROM Account a WHERE a.refreshToken = :refreshToken")})
